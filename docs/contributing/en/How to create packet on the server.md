...
0. We need to figure out how the package will be called and what data will be in it. In [MsgType.h](https://github.com/skyrim-multiplayer/skymp/blob/main/projects/server/cpp/mp_common/MsgType.h) you can see how our names usually look. Our messages are mostly in JSON format. You can read the JSON syntax on Wikipedia https://en.wikipedia.org/wiki/JSON to remind yourself what types of data can be there in principle.
