...
const FrameItem = ({ name, width = 64, height = 64, rotated = false }: FrameItemProps) => {
  return (
    <div
      style={{
...
export const SkyrimFrame = ({ width = 512, height = 704, header = true }: SkyrimFrameProps) => {
  return (
    <div className={"frame"} style={{ width: `${width}px`, height: `${height}px` }}>
      {header ? (
        ...
        <>
          ...
          <FrameItem
            name={"Border middle"}
            height={header ? height - 64 * 3 : height - 64 * 2}
            width={width - 64 * 2}
          />
